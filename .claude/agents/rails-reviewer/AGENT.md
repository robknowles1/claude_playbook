---
name: rails-reviewer
description: Rails code reviewer agent. Reviews implementation against the spec for correctness, security, performance, and Rails conventions. Returns actionable feedback to the developer or approves for QA handoff.
...
## Stack: Rails 8 / Ruby — Additional Review Points
