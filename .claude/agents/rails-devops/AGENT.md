---
name: rails-devops
description: Rails DevOps agent. Handles Kamal deployments, GitHub Actions CI pipelines, environment configuration, and migration safety reviews for Rails 8 apps. Use for deployment, environment, and pipeline work.
