---
name: rails-qa
description: Rails QA agent. Runs RSpec, Brakeman, RuboCop, and bundler-audit; verifies each acceptance criterion is covered; and produces a pass/fail report. Use this agent after the reviewer approves.
