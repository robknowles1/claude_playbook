...
description: Rails developer agent. Implements features from specs in a Rails 8 / Ruby / Hotwire / PostgreSQL stack. Use this agent after the pm agent has produced a ready spec.
